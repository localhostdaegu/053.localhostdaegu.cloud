...
- **상태:** 2026-09-20 팀 확인 기준 최신 변경 배포 갱신·제안요약서 작성·접수 완료. 시연 영상은 구현 화면으로 대체했습니다. 9/19 첫 배포·운영 페르소나 10건 검증, 11개 업종 지표 연결을 마쳤으며, 사이트는 서비스 저장소 개발 기록과 팀 확인 내용을 수동으로 반영합니다.
...
| `showcase-screens.html` | 출품 자료 하위 구현 화면 · 최신 UI 캡처 8장과 6단계 사용 흐름 |
| `assets/images/screens/`, `assets/css/screens.css` | 로컬 실백엔드로 재촬영한 화면과 구현 화면 페이지 전용 스타일 |
